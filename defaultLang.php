...
$TranslationEn = [
	...
	'data ownership' => 'Sometimes, you might have tables with data that were entered before implementing this ControlPagosV1 membership management system, or entered using other applications unaware of ControlPagosV1 ownership system. This data currently has no owners. This page allows you to assign owner groups and owner members to this data.',
	'table' => 'Table',
	...
	'compare tables page' => 'This page compares the tables and fields structure/schema as designed in ControlPagosV1 to the actual database structure and allows you to fix any deviations.',
	'field' => 'Field',
	'AppGini definition' => 'ControlPagosV1 definition',
	...
	'create it' => 'Create it',
	'fix field' => 'Fix the field by running an ALTER COLUMN query so that its definition becomes the same as that in ControlPagosV1.',
	'fix it' => 'Fix it',
	'field update warning' => 'DANGER!! In some cases, this might lead to data loss, truncation, or corruption. It might be a better idea sometimes to update the field in ControlPagosV1 to match that in the database. Would you still like to continue?',
	...
	'generated by' => 'This application was generated by ControlPagosV1 <VERSION> on <DATETIME>.',
