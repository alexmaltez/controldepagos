	...
	if($submit || $test) {
		...
		$new_config = array(
			...
			'adminConfig' => array(
				...
				'senderName' => 'Gestión de membresía',
				'senderEmail' => $email,
			...
			<div class="panel panel-success">
				...
				<div class="panel-content">
					<ul id="next-actions" class="nav nav-pills nav-stacked">
						...
						<li><a href="admin/pageHome.php"><i class="glyphicon glyphicon-cog"></i> <?php echo $Translation['setup next 2']; ?></a></li>
					</ul>
				</div>
			</div>
		</div>
